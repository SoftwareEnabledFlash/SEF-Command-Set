## Software-Enabled Flash Command Set Specification

This repository contains the command set specification to be used with the Software-Enabled Flash Project's APIs, SDKs, and assofted software.
